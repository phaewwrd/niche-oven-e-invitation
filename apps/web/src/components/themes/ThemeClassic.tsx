            ...
            {event.image1Url && (
                <section className={`relative mx-auto max-w-5xl px-4 sm:px-6 transition-all duration-1000 delay-200 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}>
                    <div className="relative rounded-3xl overflow-hidden shadow-2xl aspect-[16/10]">
                        <img src={event.image1Url} alt={`${event.groomName} & ${event.brideName}`} className="w-full h-full object-cover" />
            ...
            {event.image2Url && (
                <section className="max-w-4xl mx-auto px-4 sm:px-6 pb-20">
                    <div className="relative rounded-3xl overflow-hidden shadow-xl aspect-[4/3]">
                        <img src={event.image2Url} alt={`${event.groomName} & ${event.brideName} — portrait`} className="w-full h-full object-cover" />
                    </div>
                </section>
            )}
