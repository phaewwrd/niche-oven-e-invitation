        ...
        <form onSubmit={handleSubmit} className="space-y-8">
            <div className="flex items-center gap-4 pb-6 border-b">
                ...
                <div>
                    ...
                    <p className="text-sm text-muted-foreground font-mono">ID: {theme.id}</p>
                </div>
            </div>
            ...
            <div className="space-y-4 p-6 bg-muted/30 rounded-2xl">
                <div>
                    <Label className="text-base font-semibold">Theme Preview Image</Label>
                ...
                {formData.previewImageUrl && (
                    <div className="mt-4">
                        ...
                        <div className="relative w-full max-w-sm aspect-[3/4] rounded-xl overflow-hidden border-2 border-border">
                            <Image
            ...
            <div className="space-y-6 p-6 bg-muted/30 rounded-2xl">
                <div>
                    <Label className="text-base font-semibold">Default Theme Images</Label>
                    <p className="text-sm text-muted-foreground mt-1">
            ...
            {/* Theme Details */}
            <div className="space-y-6 p-6 bg-card rounded-2xl border-2 border-border">
                <h3 className="text-lg font-bold">Theme Details</h3>
