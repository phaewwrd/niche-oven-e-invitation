    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-3xl border border-border shadow-sm flex items-center gap-5">
                    <div className="bg-blue-50 p-4 rounded-2xl text-blue-600">
                        <Users className="w-6 h-6" />
                    </div>
                    <div>
                        <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">Total Responses</p>
                        <h3 className="text-2xl font-black">{rsvps.length}</h3>
                    </div>
                </div>
                <div className="bg-white p-6 rounded-3xl border border-border shadow-sm flex items-center gap-5">
                    ...
                    <div>
                        <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">Committed Guests</p>
                        <h3 className="text-2xl font-black text-green-600">{totalAttending}</h3>
                    </div>
                </div>
                <div className="bg-white p-6 rounded-3xl border border-border shadow-sm flex items-center gap-5">
                    <div className="bg-[#4F46E5]/5 p-4 rounded-2xl text-[#4F46E5]">
                    ...
                    <div className="flex-1">
                        ...
                        >
                            <div className="text-left">
                                <p className="text-[10px] font-black uppercase tracking-widest opacity-60">Export Registry</p>
                                <h3 className="text-sm font-black flex items-center gap-2 group-hover:gap-3 transition-all">
            ...
            <div className="bg-white rounded-[2rem] border border-border shadow-xl overflow-hidden">
                <div className="p-8 border-b border-border bg-muted/5 flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="relative flex-1 max-w-md">
                        <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground" />
                        <Input
                            placeholder="Filter by guest name or message..."
                            className="rounded-xl pl-11 py-6 bg-white border-border"
                            value={searchTerm}
                    ...
                    <table className="w-full text-left">
                        ...
                        <tbody className="divide-y divide-border">
                            ...
                            {filteredRsvps.length === 0 && (
                                <tr>
                                    <td colSpan={5} className="px-8 py-20 text-center text-muted-foreground italic font-serif opacity-50">
