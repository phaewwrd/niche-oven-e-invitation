...
export default async function UpgradePage() {
        ...
        return (
            <div className="container mx-auto p-8 max-w-2xl text-center">
                <div className="bg-green-50 border border-green-200 rounded-3xl p-12">
                    <h1 className="text-3xl font-bold text-green-800 mb-4 font-serif italic">You're Premium</h1>
                    <p className="text-green-700/80 mb-8 font-medium italic">Your architectural invitation suite is fully unlocked until {new Date(subscription.expiresAt).toLocaleDateString()}.</p>
                    <a href="/manage" className="inline-block bg-green-600 text-white px-8 py-3 rounded-xl font-bold shadow-lg shadow-green-200 hover:brightness-110 transition-all">Back to Dashboard</a>
                </div>
            </div>
        );
    }
    ...
    if (pendingPayment) {
        return (
            <div className="container mx-auto p-8 max-w-2xl text-center">
                <div className="bg-blue-50 border border-blue-100 rounded-[2.5rem] p-16 shadow-xl shadow-blue-500/5 items-center flex flex-col">
                    <div className="w-20 h-20 bg-blue-100 rounded-full flex items-center justify-center mb-8 animate-pulse">
                        <svg className="w-10 h-10 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                    </div>
                    <h1 className="text-3xl font-black mb-4 tracking-tight">Payment Verification In Progress</h1>
                    <p className="text-blue-700/60 mb-10 text-lg font-medium italic font-serif">We've received your slip. Our curators are verifying your transaction to unlock your premium experience.</p>
                    <a href="/manage" className="text-blue-800 font-black uppercase tracking-widest text-xs border-b-2 border-blue-200 hover:border-blue-600 transition-all pb-1">Return to Dashboard</a>
                </div>
            </div>
        );
    }
